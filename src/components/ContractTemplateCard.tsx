...
const ContractTemplateCard: Component<ContractTemplateCardProps> = (props) => {
  ...
  return (
    <div class="card bg-base-100 border-2 border-dashed border-primary/20 hover:border-primary/40 transition-all group">
      <div class="card-body p-6">
        <div class="flex items-center gap-3 mb-4">
          <div class="bg-primary/10 text-primary p-2 rounded-lg">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" /></svg>
          </div>
          <h3 class="font-black text-sm uppercase tracking-widest opacity-60">Missing Coverage</h3>
        </div>
        ...
        <A 
          ...
          class="btn btn-primary btn-sm rounded-xl font-black"
        >
