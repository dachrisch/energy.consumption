...
const Profile: Component = () => {
  ...
  // Initialize signals when user data loads
  const handleUserLoad = (userData: any) => {
  ...
  return (
    <div class="p-6 md:p-10 lg:p-12 max-w-2xl mx-auto flex-1 flex flex-col justify-center">
      <Show when={user()} fallback={<div class="flex justify-center py-20"><span class="loading loading-spinner loading-lg text-primary"></span></div>}>
        {(userData) => {
          if (!name()) handleUserLoad(userData());
